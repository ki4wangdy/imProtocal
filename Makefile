...
#Sources
srcs :=
srcs += ./src/header_version.c
srcs += ./src/key_value_type.c
srcs += ./src/key_value_array_type.c
srcs += ./src/str_array_type.c
srcs += ./src/header_type.c
srcs += ./src/str_type.c
srcs += ./src/int_type.c
srcs += ./src/protocal/login.c
srcs += ./src/protocal/message.c
srcs += ./src/protocal/login.c
srcs += ./src/msg_body.c	
